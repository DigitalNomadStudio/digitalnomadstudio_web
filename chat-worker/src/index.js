...
- Products shipped: TeamRelay (iOS, real-time offline speech translation for sports teams, businesses and families, on the App Store); MatchTagr (iOS, tag key match moments from an Apple Watch and build highlight reels); Touchline HQ (web, football club management: fixtures, availability, ratings, lineups); 4thebadge (web app at 4thebadge.com, a personalised football fan app that takes on the supporter's club colours, with live scores, fixtures, tables, squads and stats across 15 competitions); PropertyBuyWise (web, analysis of building, pest and strata reports); Mindset 4 Sports Performance (web, mental performance coaching for athletes); Witness Capture Proof (coming soon, tamper-proof photo and video evidence).
